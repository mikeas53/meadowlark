...
// ===== На выбор тура попадаем с главной страницы Home!!! ===
...
app.post('/cart/checkout', function(req, res){
	...
	console.log('user:'+credentials.gmail.user + ', pass:' + credentials.gmail.password);
